...
*/}}
{{- define "managed-namespace.fullname" -}}
...
*/}}
{{- define "managed-namespace.namespaceName" -}}
{{- .Release.Namespace }}
{{- end }}
...
*/}}
{{- define "managed-namespace.resourceName" -}}
{{- $fullname := include "managed-namespace.fullname" .context }}
{{- $suffix := .suffix }}
